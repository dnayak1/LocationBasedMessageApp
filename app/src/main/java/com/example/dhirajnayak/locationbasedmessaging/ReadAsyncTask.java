...
public class ReadAsyncTask extends AsyncTask<String,Void,LoginDetails> {
    IReadData activity;

    public ReadAsyncTask(IReadData activity) {
    ...
    protected void onPostExecute(LoginDetails loginDetails) {
        ...
        activity.setupReadData(loginDetails);
    }

    static public interface IReadData{
